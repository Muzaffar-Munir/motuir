...
@section('content')
    @component('components.breadcrumb')
        @slot('pageheading') Referral @endslot
        @slot('pagetitle') Home @endslot
        @slot('title') Referral @endslot
    @endcomponent
    ...
    <div class="row">
        ...
        <div class="col-md-2 no_padding">
            <div class="form-group">
                <label for="formrow-firstname-input">Paid ID</label>
                <input type="text" placeholder="Paid ID" class="form-control" id="formrow-firstname-input" >
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label for="formrow-firstname-input">Book</label>                
                <select class="form-control">
                    <option>Select</option>
                    <option>Yes</option>
                    <option>No</option>
        ...
        <div class="col-md-2 no_padding" style="padding-right: 10px;">
            <div class="form-group">
                ...
                <table class="table datatable_scroll table-centered nowrap table-check table-card-list"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="px-3 text-danger" data-placement="top" title="Book" data-original-title="Book"><i class="uil uil-briefcase font-size-18"></i> Book</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
