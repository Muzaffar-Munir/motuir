                                ...
                                <li>
                                    <div class="col-mail col-mail-1">
                                        <div class="checkbox-wrapper-mail">
                                            ...
                                            <label for="{{$ticket->id}}" class="toggle"></label>
                                        </div>
                                        <a href="{{ route('support.tickets.read') }}" class="title">{{$ticket->user_name}}</a>
                                    </div>
                                    <div class="col-mail col-mail-2">
                                        <a href="#" class="subject"><span class="badge-info badge mr-2">Support</span>Off on
                                            Thursday -
                                            <span class="teaser">{{$ticket->description}} 4 4 mar 2014 at 5:55 pm</span>
                                        </a>
                                        <div class="date" style="padding-left: 25px;"> <span data-toggle="modal"
                                                data-target="#notes" data-toggle="tooltip" data-placement="top" title="Note"
                                                style="padding-right:40px"
                                                class="star-toggle fas fa-sticky-note text-warning notes"></span> Mar 6
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#addButton').on('click', function(e) {
                console.log($('#description').summernote('code'), $('#description').summernote('code')
                    .length);
                ...
                if (!$('.user_name').val() || !$('.subject_title').val() || !$('#description').summernote(
                        'code').length) {
                ...
                $.ajax({
                    ...
                    success: function(name) {
                        ...
                        //    alert("Success!", "New user created with a name of: "+name, "success");
