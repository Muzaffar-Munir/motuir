...
@section('title') Suspended @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        @slot('pageheading') Suspended @endslot
        @slot('pagetitle') Cash Stations @endslot
        @slot('title') Suspended @endslot
    @endcomponent
                        ...
                        <table class="table datatable1 table-responsive table-centered table-nowrap table-check mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{route('users.user.details')}}" style="color: inherit;">27 Nov 2020</a></td>
                                    <td>
                                         <a href="{{route('users.user.details')}}" style="color: inherit;">
