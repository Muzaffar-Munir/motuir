...
@section('title') Currencies - New Request @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        @slot('pageheading') New Request  @endslot
        @slot('pagetitle') Currencies @endslot
        @slot('title') New Request @endslot
    @endcomponent
            ...
            <table class="table table-centered datatable1 dt-responsive nowrap table-card-list table-check"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>                                
                                <button type="button" class="btn btn-success btn-sm waves-effect waves-light">Approve  </button>

                                <button type="button" class="btn btn-danger btn-sm waves-effect waves-light" data-toggle="modal" data-target="#reject_req">Reject</button>
                            </td>
                        </tr>
