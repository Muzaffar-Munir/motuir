...
@section('title') Important notice @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        @slot('pageheading') Important notice @endslot
        @slot('pagetitle') System @endslot
        @slot('title') Important notice @endslot
    @endcomponent
                    ...
                    <div class="tab-content p-3 text-muted">
                        ...
                        <div class="tab-pane" id="navtabs-messages" role="tabpanel">
                            ...
                            <div class="table-responsive mb-4">
                                ...
                                <table style="width:100%;" class="table datatable2 dt-responsive table-centered table-nowrap table-check mb-0">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="width: 50px;">
                                                <div class="custom-control custom-checkbox">
