...
@section('content')
    @component('components.breadcrumb')
        @slot('pageheading') Promotion @endslot
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#navtabs-home" role="tab">
                                ...
                                <span class="d-none d-sm-block">Advertising</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#navtabs-profile" role="tab">
                                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                <span class="d-none d-sm-block">Influencer</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content p-3 text-muted">
                                ...
                                <table class="table datatable1 table-responsive table-centered table-nowrap table-check mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Media involved</th>
                        ...
                        <div class="tab-pane" id="navtabs-profile" role="tabpanel">
                            ...
                            <div class="table-responsive mb-4">
                                ...
                                <table class="table datatable2 dt-responsive table-centered table-nowrap table-check mb-0">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="width: 50px;">
                                                <div class="custom-control custom-checkbox">
                        ...
                        <div class="tab-pane" id="navtabs-messages" role="tabpanel">
                            ...
                            <div class="table-responsive mb-4">
                                ...
                                <table class="table datatable3 dt-responsive table-centered table-nowrap table-check mb-0">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="width: 50px;">
                                                <div class="custom-control custom-checkbox">
